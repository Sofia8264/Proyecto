...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    $user_sistema = new Rol();

    $lista = $user_sistema->listar_rol();
    $prueba = $user_sistema->listar_rol_x_id(1);
    ?>
        <div class="container">
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="editar_rol.php?idRol=<?php echo $lista[$x]['id_rol'] ?>">
                                <button class="btn btn-warning">Editar</button>
                            </a>
                            <button onclick="confirmar_borrar_materia(<?php echo $lista[$x]['nombre'] ?>)" class="btn btn-danger">Eliminar</button>
                        </td>
                    </tr>
