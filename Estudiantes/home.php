...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="row">
  <div class="col">
    <a href="E_estudiates/Materias.php" class="btn btn-primary" style='width:300px; height:150px'>Materias</a><br></br>
    <a href="E_estudiates/notas.php" class="btn btn-primary" style='width:300px; height:150px'>Notas</a><br></br>
  </div>
    </div>
